...
const damageproduct= require("./routes/storedamageproduct.route");
const addDamageProduct = require("./controllers/storedamageproduct.controllers");
...
app.use("/api/damageproduct", damageproduct);
